...
class Tomato_plant_frame(Toplevel):
    def __init__(self):
        Toplevel.__init__(self)
        self.geometry('800x650+1000+200')
        self.title("Detect Tomato plant disease")
        ...
        img_jpg = Image.open(r"icon_image/tomato_plant.jpg")
        ...
        self.heading = Label(self.top, text='Detect Tomato Plants disease', font='Arial 28 bold',
                             bg='#fff',fg='#620D0D')
        ...
        self.search_btn = Button(self.top, text='Search', font='Consolas 14 bold', width=22, bg="#444491",
                                 fg="#FFF", command=self.search_fun)
    ...
    def submit_fun(self):
        self.apple = pd.read_csv("text files/tomato_plant.csv", squeeze=True, usecols=["class"])
        self.catagory = list(self.apple)
        self.pickle_in = open("models/tomato_plant_Model.p", "rb")
