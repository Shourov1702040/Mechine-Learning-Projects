...
class Banana_fruit_frame(Toplevel):
    def __init__(self):
        Toplevel.__init__(self)
        self.geometry('800x650+1000+200')
        self.title("Detect Banana disease")
        ...
        img_jpg = Image.open(r"icon_image/banana.jpg")
        ...
        self.heading = Label(self.top, text='Detect Banana Fruit disease', font='Arial 28 bold',
                             bg='#fff',fg='#5860D5')
        ...
        self.submit_btn = Button(self.top,text='Submit',font='consolas 17 bold',fg="#fff",bg="#09AD1A",width=12,bd=3,
        ...
        # self.disease_val.set("Mechine Learning")
        self.disease_label = Label(self.top,font='Arial 15 bold',bg="#fff",textvariable=self.disease_val,fg="#C20202")
    ...
    ###################################   prediction function         ##################################
    def submit_fun(self):
        self.apple = pd.read_csv("text files/banana_fruit.csv", squeeze=True, usecols=["class"])
        self.catagory = list(self.apple)
        self.pickle_in = open("models/banana_fruit_Model.p", "rb")
    ...
    def solution(self):
        ...
        self.sol = pd.read_csv("text files/banana_fruit.csv", squeeze=True, usecols=["sol"])
    ...
    def symptons(self):
        self.text.delete(1.0, END)
        self.sol = pd.read_csv("text files/banana_fruit.csv", squeeze=True, usecols=["lokkhon"])
        self.sol = list(self.sol)
        no_comma_str = self.sol[self.class_id].replace('#',',')
        string_t = ''
        for i in no_comma_str.split('@'):
