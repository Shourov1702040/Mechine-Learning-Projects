...
class Potato_plant_frame(Toplevel):
    def __init__(self):
        Toplevel.__init__(self)
        self.geometry('800x650+1000+200')
        self.title("Detect Potato plant disease")
        ...
        ####################### top frame  me desigh  ###########################################
        # self.top_image = PhotoImage(file=r'icon_image/potato_plant.png')
        img_jpg = Image.open(r"icon_image/potato_plant1.png")
        ...
        self.heading = Label(self.top, text='Detect Potato Plants disease', font='Arial 28 bold',
                             bg='#fff',fg='#a67d00')
    ...
    def submit_fun(self):
        self.apple = pd.read_csv("text files/potato_plant.csv", squeeze=True, usecols=["class"])
        self.catagory = list(self.apple)
        self.pickle_in = open("models/potato_plant_Model.p", "rb")
    ...
    def solution(self):
        ...
        self.sol = pd.read_csv("text files/potato_plant.csv", squeeze=True, usecols=["sol"])
    ...
    def symptons(self):
        self.text.delete(1.0, END)
        self.sol = pd.read_csv("text files/potato_plant.csv", squeeze=True, usecols=["lokkhon"])
        self.sol = list(self.sol)
        no_comma_str = self.sol[self.class_id].replace('#',',')
        string_t = ''
        for i in no_comma_str.split('@'):
