...
class Apple_fruit_frame(Toplevel):
    def __init__(self):
        ...
        img_jpg = Image.open(r"icon_image/apple.jpg")
        ...
        self.heading = Label(self.top, text='Detect Apple Fruit disease', font='Arial 28 bold',
                             bg='#fff',fg='#5860D5')
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  -x- Functions -x- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    def symptons(self):
        self.text.delete(1.0, END)
        self.sol = pd.read_csv("text files/apple_fruit.csv", squeeze=True, usecols=["lokkhon"])
        self.sol = list(self.sol)
        no_comma_str = self.sol[self.class_id].replace('#',',')
        string_t = ''
        for i in no_comma_str.split('@'):
