...
#_________________________________ PARAMETERS ____________________________________
...
batchSizeVal= 50
epochsVal = 20
stepsPerEpochVal = (int(len(images))//batchSizeVal) * 4
###############################################################
...
pickle_out= open("tomato_plant_Model.p", "wb")
